---
name: code-review
description: Post-commit code reviewer for Crewculator. Reviews recent changes for pattern consistency, missing error/loading states, and convention violations. Advisory only — flags issues, doesn't block.
---
